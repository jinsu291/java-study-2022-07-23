...
abstract static class 비행아이템 {
    ...
    static class 날개로나는비행아이템 extends 비행아이템 {
    String get작동메세지() {
        return "날개로 날아 갑니다.";
    }
}

    static class 못나는비행아이템 extends 비행아이템 {
    String get작동메세지() {
        return "저는 못 날아요 ㅠㅠ";
    }
}

    static class 로켓비행아이템 extends 비행아이템 {
    String get작동메세지() {
        return "로켓파워로 날아갑니다!!!";
    }
}
