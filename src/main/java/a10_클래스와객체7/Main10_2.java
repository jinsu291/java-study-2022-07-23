...
// 상황 : DVD방에 3개의 서로다른 tv가 있다. 영업을 하다보니 각 tv의 특별한 기능은 거의 사용될 일이 없고 기본적인 켜기/끄기
// 만 사용된다. 현재 리모콘이 3개나 있는습니다.
...
public class Main10_2 {
    ...
    static class 샤오미Tv extends 표준Tv {
        void 켜기() {
    ...
    static class 삼성Tv extends 표준Tv {
        void 켜기() {
    ...
    static class LGTv extends 표준Tv {
        void 켜기() {
